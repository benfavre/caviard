...
const platforms = [
  { label: "Windows", detail: "PC · processeur Intel ou AMD 64 bits", suffix: "win-x64.exe", format: "Installateur .exe", mark: "⊞" },
  { label: "Mac Apple Silicon", detail: "Mac avec puce Apple M1, M2, M3…", suffix: "mac-arm64.dmg", format: "Image disque .dmg", mark: "⌘" },
  { label: "Mac Intel", detail: "Mac avec processeur Intel", suffix: "mac-x64.dmg", format: "Image disque .dmg", mark: "⌘" },
  { label: "Linux", detail: "PC · processeur Intel ou AMD 64 bits", suffix: "linux-x86_64.AppImage", format: "Application .AppImage", mark: ">_" },
];
...
export default function Page(): any {
  return <main className="ipdf">
    <link rel="stylesheet" href="/inklura-pdf/page.css?v=1.1.0-1" />
