// Inline SVG icon set — replaces lucide-react (the original tools used lucide).
// Each entry is the inner markup of a 24×24 stroke icon (stroke=currentColor).
// Rendered by <Icon name=… /> via dangerouslySetInnerHTML so multi-element
// glyphs (rect+line+path) work. Paths are lucide-faithful.
...
export const ICONS: Record<string, string> = {
  ...
  signature: '<path d="m21 17-2.156-1.868A.5.5 0 0 0 18 15.5v.5a.5.5 0 0 1-.852.354L16 15a3 3 0 1 0-4.243 4.243"/><path d="M3 21c1.5 0 2.5-.5 3.5-1.5"/><path d="M21 3 11 13"/>',
...
export function Icon(props: { name: string; className?: string; size?: number; strokeWidth?: number }): any {
  const inner = ICONS[props.name] ?? ICONS.wrench;
